...
export async function GET() {
  ...
  lines.push(`- Authorised installer for: Gree, Daikin, Panasonic, Mitsubishi Electric, LG, Samsung`);
  lines.push("");
